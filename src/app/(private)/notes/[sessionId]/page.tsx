...
const QUESTIONS = [
  { id: 'q1', text: 'Did you need to manage maladaptive communication (related to, e.g., high anxiety, high reactivity, repeated questions, or disagreement) among participants that complicates delivery of care?', answer: false, code: '90785', note: 'The need to manage maladaptive communication (related to high anxiety, high reactivity, repeated questions, and/or disagreement) complicated delivery of care, increasing session intensity. This required repeated de-escalation, emotional containment, and redirection beyond standard psychotherapy to implement the treatment plan and achieve therapeutic progress.' },
